...
OmegadgeSprite::	     INCBIN "gfx/sprites/omegadge.2bpp"
...
NidoranSprite::			INCBIN "gfx/sprites/nidoran.2bpp"
DoomsdaySprite::		INCBIN "gfx/sprites/doomsday.2bpp"
ImakuniSprite::			INCBIN "gfx/sprites/imakuni.2bpp"
...
MushroomSprite::		INCBIN "gfx/sprites/mushroom.2bpp"