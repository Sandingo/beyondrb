...
; Characteristics of each move.
	...
	move IRON_BASH,	   ATTACK_TWICE_EFFECT,         60, STEEL,        100,  5
	...
	move CROSS_CUTTER, NO_ADDITIONAL_EFFECT,        70, BUG,     	  100, 20
	move FAIRY_WIND,   NO_ADDITIONAL_EFFECT,        40, FAIRY,        100, 25
	move MOONBLAST,    SPECIAL_DOWN_SIDE_EFFECT,    95, FAIRY,        100, 10
	move TRIPLE_KICK,  ATTACK_THRICE_EFFECT,	   	20, FIGHTING,	   90, 10
	move ICICLE_SPEAR, TWO_TO_FIVE_ATTACKS_EFFECT,  15, ICE,	   	  100, 30
	move FEATHERDANCE, SPEED_DOWN2_EFFECT,			 0, FLYING,       100, 15
	...
	move NUMB_PINCER,  PARALYZE_SIDE_EFFECT1,       60, BUG,           95, 15
	...
	move GASTRO_ACID,  ACCURACY_DOWN_SIDE_EFFECT,   25, POISON,       100, 20
