...
; commands that are used to go to the next set of credits texts.
	db CRED_MON, CRED_VERSION, CRED_US_STAFF, CRED_TEXT_FADE_MON
	...
	db CRED_SOUND_EFFECTS, CRED_MASUDE, CRED_TEXT_FADE_MON
	...
	db CRED_GAME_SCENE, CRED_TANIGUCHI, CRED_NONOMURA, CRED_ZINNAI, CRED_TEXT_FADE_MON
	...
	db CRED_PRODUCERS, CRED_MIYAMOTO, CRED_KAWAGUCHI, CRED_ISHIHARA, CRED_TEXT_FADE
	db CRED_US_COORD, CRED_TILDEN,  CRED_HARADA, CRED_HI_NAKAMURA, CRED_TEXT_FADE
	...
	db CRED_SPECIAL, CRED_IWATA, CRED_HARADA, CRED_TEXT
