MapSongBanks::
	...
	db MUSIC_ROUTES2, BANK(Music_Routes2) ; MT_SILVER_FRONT
	db MUSIC_CINNABAR, BANK(Music_Cinnabar) ; CITRINE_ISLAND
	...
	db MUSIC_ROUTES2, BANK(Music_Routes2) ; ROUTE_28
	...
	db MUSIC_VERMILION, BANK(Music_Vermilion) ; VERMILION_HOUSES
	...
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; SEAFOAM_ISLANDS_B5F
	...
	db MUSIC_DUNGEON2, BANK(Music_IndigoPlateau) ; ROUTE_22_GATE
...
;	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; UNUSED_MAP_CD
	...
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; SAFARI_ZONE_EXPANSION
...
;	db MUSIC_SILPH_CO, BANK(Music_SilphCo) ; UNUSED_MAP_F1
	...
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; MT_MOON_HOUSE
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; MT SILVER F1
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; MT SILVER F2
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; MT SILVER F3
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; MT SILVER EXTERIOR
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; MT SILVER PEAK
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; MT SILVER EXTRA ROOMS
	...
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; League HQ B7F
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion) ; League HQ B8F
