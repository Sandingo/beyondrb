	...
	const_export ROUTE23_SWIMMER_M1
	const_export ROUTE23_SWIMMER_M2
...
Route23_Object:
	...
	object_event  8, 85, SPRITE_SWIMMER_M, STAY, DOWN, TEXT_ROUTE23_SWIMMER_M1
	object_event 11, 96, SPRITE_SWIMMER_M, STAY, DOWN, TEXT_ROUTE23_SWIMMER_M2
