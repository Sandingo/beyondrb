...
ViridianForest_Object:
	...
	object_event  6, 39, SPRITE_COOLTRAINER_F, STAY, ANY_DIR, TEXT_VIRIDIANFOREST_COOLTRAINER_F, LASS, 19 ; new
	object_event 11, 18, SPRITE_YOUNGSTER, STAY, RIGHT, TEXT_VIRIDIANFOREST_YOUNGSTER5, BUG_CATCHER, 15 ; new
