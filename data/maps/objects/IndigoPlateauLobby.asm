	...
	const_export INDIGOPLATEAULOBBY_RELEARNER
	const_export INDIGOPLATEAULOBBY_CHANSEY
	const_export INDIGOPLATEAULOBBY_ABRA
...
;	warp_event  8,  0, LORELEIS_ROOM, 1 - OG
	...
	object_event 9,  7,  SPRITE_GRAMPS, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_RELEARNER
	object_event  8,  5, SPRITE_CHANSEY, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_CHANSEY
	object_event  9,  1, SPRITE_ABRA, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_ABRA
