...
SilphCo5F_Object:
	...
	object_event 26, 14, SPRITE_ROCKER, STAY, UP, TEXT_SILPHCO5F_ROCKER, OPP_JUGGLER, 1
	object_event 28,  4, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO5F_ROCKET2, OPP_ROCKET, 29
	object_event 18, 10, SPRITE_ROCKER, STAY, ANY_DIR,  TEXT_SILPHCO5F_HITECHJACK
	...
	object_event 21, 16, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO5F_NUGGET, NUGGET
	object_event 19, 10, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO5F_CARD_KEY, CARD_KEY
