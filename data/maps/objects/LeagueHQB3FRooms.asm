LeagueHQB3FRooms_Object:
	...
	def_object_events
	object_event  2,  2, SPRITE_COOLTRAINER_M, STAY, DOWN, 1, COOLTRAINER_M, 8
	object_event 12,  4, SPRITE_GENTLEMAN, STAY, ANY_DIR, 2, GENTLEMAN, 4
	object_event  0, 13, SPRITE_COOLTRAINER_F, STAY, ANY_DIR, 3, COOLTRAINER_F, 8
