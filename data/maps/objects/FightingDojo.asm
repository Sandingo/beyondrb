...
FightingDojo_Object:
	...
	def_warp_events
	warp_event  6, 11, LAST_MAP, 2
	warp_event  7, 11, LAST_MAP, 2

	def_bg_events

	def_object_events
	object_event  7,  3, SPRITE_HIKER, STAY, DOWN, TEXT_FIGHTINGDOJO_KARATE_MASTER, OPP_BLACKBELT, 1
	...
	object_event  8,  5, SPRITE_HIKER, STAY, LEFT, TEXT_FIGHTINGDOJO_BLACKBELT3, OPP_BLACKBELT, 4
	object_event  8,  7, SPRITE_HIKER, STAY, LEFT, TEXT_FIGHTINGDOJO_BLACKBELT4, OPP_BLACKBELT, 5
