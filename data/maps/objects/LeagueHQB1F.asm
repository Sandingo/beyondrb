LeagueHQB1F_Object:
	...
	def_object_events
	object_event 3, 14, SPRITE_COOLTRAINER_M, STAY, DOWN, 1, OPP_COOLTRAINER_M, 4
	object_event 8, 12, SPRITE_COOLTRAINER_F, STAY, UP, 2, OPP_COOLTRAINER_F, 4
	object_event 17,  1, SPRITE_POKE_BALL, STAY, NONE, 3, TM_SUBMISSION
