LeagueHQB1F_Object:
	...
	def_object_events
	object_event 3, 14, SPRITE_COOLTRAINER_M, STAY, DOWN, TEXT_LEAGUEHQB1F_TRAINER_0, COOLTRAINER_M, 4
	object_event 8, 12, SPRITE_COOLTRAINER_F, STAY, ANY_DIR, TEXT_LEAGUEHQB1F_TRAINER_1, COOLTRAINER_F, 4
