...
;const_export SILPHCO11F_ARCHER
;const_export SILPHCO11F_OMEGADGE
	const_export SILPHCO11F_ELECTIRIZER
...
SilphCo11F_Object:
	...
	object_event  4, 16, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO11F_ARCHER, OPP_ARCHER, 2
	object_event 15,  9, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO11F_ROCKET2, OPP_ROCKET, 40
;object_event  4, 14, SPRITE_ROCKET, STAY, LEFT, TEXT_SILPHCO11F_ARCHER
;object_event  4, 15, SPRITE_OMEGADGE, STAY, LEFT, TEXT_SILPHCO11F_OMEGADGE
	object_event 14, 16,  SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO11F_ELECTIRIZER, ELECTIRIZER
