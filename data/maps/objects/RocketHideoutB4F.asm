	...
	const_export ROCKETHIDEOUTB4F_ARCHER
	...
	const_export ROCKETHIDEOUTB4F_UP_GRADE
...
RocketHideoutB4F_Object:
	...
	object_event 25,  6, SPRITE_ROCKET, STAY, DOWN, TEXT_ROCKETHIDEOUTB4F_ARCHER
	...
	object_event 11, 10, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB4F_UP_GRADE, UP_GRADE
