	...
	const_export ROCKTUNNELPOKECENTER_AIDE
...
RockTunnelPokecenter_Object:
	...
	object_event 10,  6, SPRITE_GENTLEMAN, WALK, LEFT_RIGHT, TEXT_ROCKTUNNELPOKECENTER_GENTLEMAN
	...
	object_event  5,  3, SPRITE_SCIENTIST, STAY, DOWN, TEXT_ROCKTUNNELPOKECENTER_AIDE
