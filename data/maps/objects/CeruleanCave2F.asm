...
CeruleanCave2F_Object:
	...
	object_event 19, 15, SPRITE_FOSSIL, STAY, NONE, TEXT_CERULEANCAVE2F_HELIX_FOSSIL, HELIX_FOSSIL
	object_event 19, 15, SPRITE_FOSSIL, STAY, NONE, TEXT_CERULEANCAVE2F_DOME_FOSSIL, DOME_FOSSIL
