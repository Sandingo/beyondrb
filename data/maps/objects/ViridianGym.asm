	...
	const_export VIRIDIANGYM_KYLE
	const_export VIRIDIANGYM_REVIVE
	const_export VIRIDIANGYM_PROTECTOR
...
ViridianGym_Object:
	...
	object_event 11, 11, SPRITE_HIKER, STAY, UP, TEXT_VIRIDIANGYM_HIKER1, OPP_BLACKBELT, 5
	object_event 10,  7, SPRITE_ROCKER, STAY, DOWN, TEXT_VIRIDIANGYM_ROCKER1, OPP_TAMER, 3
	object_event  3,  7, SPRITE_HIKER, STAY, LEFT, TEXT_VIRIDIANGYM_HIKER2, OPP_BLACKBELT, 6
	object_event 13,  5, SPRITE_COOLTRAINER_M, STAY, RIGHT, TEXT_VIRIDIANGYM_COOLTRAINER_M2, OPP_COOLTRAINER_M, 10
	object_event 10,  1, SPRITE_HIKER, STAY, DOWN, TEXT_VIRIDIANGYM_HIKER3, OPP_BLACKBELT, 7
	...
	object_event 2, 1, SPRITE_SUPER_NERD, STAY, DOWN, TEXT_VIRIDIANGYM_KYLE, OPP_KYLE, 2
	object_event 16,  9, SPRITE_POKE_BALL, STAY, NONE, TEXT_VIRIDIANGYM_REVIVE, REVIVE
	object_event  6,  1, SPRITE_POKE_BALL, STAY, NONE, TEXT_VIRIDIANGYM_PROTECTOR, PROTECTOR
