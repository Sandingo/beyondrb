...
;	object_event 32, 18, SPRITE_POKE_BALL, STAY, NONE, TEXT_POWERPLANT_VOLTORB2, VOLTORB, 40 | OW_POKEMON ; Too many sprites in an area causes some funkiness
	...
	object_event  4,  9, SPRITE_ZAPDOS,    STAY, UP, TEXT_POWERPLANT_ZAPDOS, ZAPDOS, 50 | OW_POKEMON
	...
	object_event 32, 18, SPRITE_POKE_BALL, STAY, NONE, TEXT_POWERPLANT_METAL_COAT, METAL_COAT
