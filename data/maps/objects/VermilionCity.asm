	...
	const_export VERMILIONCITY_MINA
...
VermilionCity_Object:
	...
	warp_event 23, 19, VERMILION_HOUSES, 5
	warp_event 18, 31, VERMILION_DOCK, 1
	warp_event 19, 31, VERMILION_DOCK, 1
	warp_event 15, 13, VERMILION_HOUSES, 1
	warp_event  7,  3, VERMILION_HOUSES, 3
	...
	object_event 29,  9, SPRITE_MACHOP, STAY, ANY_DIR, TEXT_VERMILIONCITY_MACHOP
	object_event 23, 27, SPRITE_SAILOR, WALK, LEFT_RIGHT, TEXT_VERMILIONCITY_SAILOR2
	object_event 19, 15, SPRITE_OFFICER_JENNY, STAY, DOWN, TEXT_VERMILIONCITY_OFFICER_JENNY
	object_event 29, 27, SPRITE_MINA, STAY, DOWN, TEXT_VERMILIONCITY_MINA
