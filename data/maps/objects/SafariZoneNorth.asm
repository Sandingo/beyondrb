	object_const_def
	const_export SAFARIZONENORTH_WORKER_1
	const_export SAFARIZONENORTH_WORKER_2
...
SafariZoneNorth_Object:
	...
	warp_event 16,  0, SAFARI_ZONE_EXPANSION, 1
	warp_event 17,  0, SAFARI_ZONE_EXPANSION, 2
	...
	def_object_events
	object_event 16,  0, SPRITE_SAFARI_ZONE_WORKER, STAY, DOWN, TEXT_SAFARIZONENORTH_WORKER_1
	object_event 17,  0, SPRITE_SAFARI_ZONE_WORKER, STAY, DOWN, TEXT_SAFARIZONENORTH_WORKER_2
