...
;	dw NoHS
	...
	dw MtSilverF2HS
	dw MtSilverF3HS
	dw MtSilverExteriorHS ; MtSilverExterior
	dw MtSilverPeakHS
	dw MtSilverExtraRoomsHS ; MtSilverExtraRooms
...
VermilionCityHS:
	db VERMILION_CITY, VERMILIONCITY_OFFICER_JENNY, SHOW
	db VERMILION_CITY, VERMILIONCITY_MINA,          HIDE
SaffronCityHS:
...
Route1HS:
	db ROUTE_1, ROUTE1_YOUNGSTER3,					HIDE
Route2HS:
...
Route12HS:
	...
	db ROUTE_12, ROUTE12_TM_DAZZLINGLEAM, SHOW
Route15HS:
	db ROUTE_15, ROUTE15_TM_RAGE, SHOW
Route16HS:
	db ROUTE_16, ROUTE16_SNORLAX, SHOW
Route20HS:
	db ROUTE_20, ROUTE20_KINGS_ROCK, SHOW
Route22HS:
...
Route24HS:
	...
	db ROUTE_24, ROUTE24_CHARMANDER_GUY,  SHOW
Route25HS:
	db ROUTE_25, ROUTE25_TM_SEISMIC_TOSS, SHOW
Route28HS:
	db ROUTE_28, ROUTE28_TM_STEEL_WING, SHOW	
BluesHouseHS:
...
ViridianSchoolHS:
	db VIRIDIAN_SCHOOL_HOUSE, VIRIDIANSCHOOLHOUSE_KYLE, SHOW
ViridianGymHS:
	db VIRIDIAN_GYM, VIRIDIANGYM_GIOVANNI, SHOW
	db VIRIDIAN_GYM, VIRIDIANGYM_KYLE, HIDE
	db VIRIDIAN_GYM, VIRIDIANGYM_REVIVE,   SHOW
	db VIRIDIAN_GYM, VIRIDIANGYM_PROTECTOR,   SHOW
Museum1FHS:
...
GameCornerHS:
	...
	db GAME_CORNER, GAMECORNER_IMAKUNI, HIDE
WardensHouseHS:
...
IndigoPlateuLobbyHS:
	db INDIGO_PLATEAU_LOBBY, INDIGOPLATEAULOBBY_ABRA,     HIDE
FightingDojoHS:
	db FIGHTING_DOJO, FIGHTINGDOJO_HITMONLEE_POKE_BALL,  SHOW
	db FIGHTING_DOJO, FIGHTINGDOJO_HITMONCHAN_POKE_BALL, SHOW
	db FIGHTING_DOJO, FIGHTINGDOJO_HITMONTOP_POKE_BALL,  SHOW
SilphCo1FHS:
	db SILPH_CO_1F, SILPHCO1F_LINK_RECEPTIONIST, HIDE
RockTunnel1FHS:
	db ROCK_TUNNEL_1F, ROCKTUNNEL1F_TM_STEEL_WING, SHOW
PowerPlantHS:
	db POWER_PLANT, POWERPLANT_VOLTORB1,   SHOW
;	db POWER_PLANT, POWERPLANT_VOLTORB2,   SHOW - removed
	...
	db POWER_PLANT, POWERPLANT_METAL_COAT, SHOW
VictoryRoad2FHS:
...
MtMoon1FHS:
	...
	db MT_MOON_1F, MTMOON1F_ANTIDOTE,   SHOW
...
MtMoonB1FHS:
	db MT_MOON_B1F, MTMOONB1F_WING_FOSSIL,   SHOW
	db MT_MOON_B1F, MTMOONB1F_TINYMUSHROOM1,   SHOW
	db MT_MOON_B1F, MTMOONB1F_TINYMUSHROOM2,   SHOW
	db MT_MOON_B1F, MTMOONB1F_TINYMUSHROOM3,   SHOW
	db MT_MOON_B1F, MTMOONB1F_TINYMUSHROOM4,   SHOW
MtMoonB2FHS:
...
CeruleanTradeHouseHS:
	db CERULEAN_TRADE_HOUSE, CERULEANTRADEHOUSE_MELANIE, SHOW
SSAnne2FHS:
...
RocketHideoutB4FHS:
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_ARCHER,         SHOW
	...
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_UP_GRADE,      SHOW
SilphCo2FHS:
...
SilphCo5FHS:
	...
	db SILPH_CO_5F, SILPHCO5F_HITECHJACK,   SHOW
	db SILPH_CO_5F, SILPHCO5F_TM_TAKE_DOWN, SHOW
	db SILPH_CO_5F, SILPHCO5F_PROTEIN,      SHOW
	db SILPH_CO_5F, SILPHCO5F_NUGGET,       SHOW
	db SILPH_CO_5F, SILPHCO5F_CARD_KEY,     HIDE
SilphCo6FHS:
...
SilphCo10FHS:
	...
	db SILPH_CO_10F, SILPHCO10F_TM_FLAMETHROWER,SHOW
SilphCo11FHS:
...
PokemonMansion3FHS:
	...
	db POKEMON_MANSION_3F, POKEMONMANSION3F_BLK_AUGURITE, SHOW
PokemonMansionB1FHS:
	...
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_MAGMARIZER,   SHOW
SafariZoneEastHS:
	...
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_TM_HEADBUTT,  SHOW
SafariZoneNorthHS:
	db SAFARI_ZONE_NORTH, SAFARIZONENORTH_WORKER_1,	SHOW
	db SAFARI_ZONE_NORTH, SAFARIZONENORTH_WORKER_2,	SHOW
...
SafariZoneCenterHS:
	...
	db SAFARI_ZONE_CENTER, SAFARIZONECENTER_TM_LUNGE, SHOW
CeruleanCave2FHS:
	...
	db CERULEAN_CAVE_2F, CERULEANCAVE2F_HELIX_FOSSIL, HIDE
	db CERULEAN_CAVE_2F, CERULEANCAVE2F_DOME_FOSSIL, HIDE
CeruleanCaveB1FHS:
...
Route22GateHS:
	db ROUTE_22_GATE, ROUTE22GATE_SILVERGUARD_1, SHOW
	db ROUTE_22_GATE, ROUTE22GATE_SILVERGUARD_2, SHOW
VictoryRoad1FHS:
...
SeafoamIslandsB3FHS:
	...
	db SEAFOAM_ISLANDS_B3F, SEAFOAMISLANDSB3F_DRAGON_SCALE, SHOW
MtSilverF1HS:
	db MT_SILVER_F1, MTSILVERF1_XACCURACY, SHOW
	db MT_SILVER_F1, MTSILVERF1_ESCAPEROPE, SHOW
	db MT_SILVER_F1, MTSILVERF1_ULTRABALL, SHOW
	db MT_SILVER_F1, MTSILVERF1_MAXELIXIR, SHOW
MtSilverF2HS:
	db MT_SILVER_F2, MTSILVERF2_PPUP, SHOW
...
MtSilverF3HS:
	db MT_SILVER_F3, MTSILVERF3_MAXELIXIR, SHOW
	db MT_SILVER_F3, MTSILVERF3_MAXREVIVE, SHOW
	db MT_SILVER_F3, MTSILVERF3_PROTEIN, SHOW
	db MT_SILVER_F3, MTSILVERF3_CALCIUM, SHOW
MtSilverExteriorHS:
	db MT_SILVER_EXTERIOR, MTSILVEREXTERIOR_ESCAPEROPE, SHOW
	db MT_SILVER_EXTERIOR, MTSILVEREXTERIOR_TMROCKSLIDE, SHOW
MtSilverPeakHS:
	db MT_SILVER_PEAK, MTSILVERPEAK_MAXREPEL, SHOW
	db MT_SILVER_PEAK, MTSILVERPEAK_SUNSTONE, SHOW
MtSilverExtraRoomsHS:
	db MT_SILVER_EXTRA_ROOMS, MTSILVEREXTRAROOMS_CANDYJAR, SHOW
	db MT_SILVER_EXTRA_ROOMS, MTSILVEREXTRAROOMS_FULLRESTORE, SHOW
MtSilverSummitHS:
	db MT_SILVER_SUMMIT, MTSILVERSUMMIT_OAK, SHOW
LeagueHQB1FHS:
	db LEAGUE_HQ_B1F, LEAGUEHQB1F_TM_SUBMISSION,     SHOW
LeagueHQB2FHS:
	db LEAGUE_HQ_B2F, LEAGUEHQB2F_MAX_POTION,     SHOW
LeagueHQB3FHS:
	db LEAGUE_HQ_B3F, LEAGUEHQB3F_TM_SKY_ATTACK,     SHOW
LeagueHQB3FRoomsHS:
	db LEAGUE_HQ_B3F_ROOMS, LEAGUEHQB3FROOMS_FULL_HEAL,    		 SHOW
	db LEAGUE_HQ_B3F_ROOMS, LEAGUEHQB3FROOMS_PROTEIN,    		 SHOW
	db LEAGUE_HQ_B3F_ROOMS, LEAGUEHQB3FROOMS_GUARD_SPEC,    	 SHOW
	db LEAGUE_HQ_B3F_ROOMS, LEAGUEHQB3FROOMS_HYPER_POTION,   	  SHOW
LeagueHQB5FHS:
	db LEAGUE_HQ_B5F, LEAGUEHQB5F_FULL_RESTORE,     SHOW
	db LEAGUE_HQ_B5F, LEAGUEHQB5F_TM_DOUBLE_EDGE,     SHOW
LeagueHQB6FHS:
	db LEAGUE_HQ_B6F, LEAGUEHQB6F_MAX_POTION,     SHOW
	db LEAGUE_HQ_B6F, LEAGUEHQB6F_REVIVE,     SHOW
LeagueHQB7FHS:
	db LEAGUE_HQ_B7F, LEAGUEHQB7F_ULTRA_BALL,     SHOW
LeagueHQB8FHS:
	db LEAGUE_HQ_B8F, LEAGUEHQB8F_MAX_REVIVE,     SHOW
	db LEAGUE_HQ_B8F, LEAGUEHQB8F_HP_UP,     SHOW
	db $FF, $01, SHOW ; end
