...
ProfOakData:
; Mt Silver Summit
	db $FF, 66, TAUROS, 67, GYARADOS,  68, ARCANINE,  69, VENUSAUR,  70, ESPEON, 71, GOROCHU, 0
	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, GYARADOS,  69, CHARIZARD, 70, ESPEON, 71, GOROCHU, 0
	db $FF, 66, TAUROS, 67, ARCANINE,  68, EXEGGUTOR, 69, TOTARTLE,  70, ESPEON, 71, GOROCHU, 0
