...
MistyData:
	...
	db $FF, 60, GOLDUCK, 61, SHARPOON, 62, BLASTOISE, 63, KINGDRA, 64, STARMIE, 0
...
ErikaData:
	...
	db $FF, 60, JUNGELA, 61, EXEGGUTOR, 62, PARASECT, 63, BELLIGNANT, 64, BELLOSSOM, 0
...
; Route 22
	...
	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, SKULKRAKEN, 47, GROWLITHE, 50, ALAKAZAM, 53, VENUSAUR, 0
	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, EXEGGCUTE, 47, SKULKRAKEN, 50, ALAKAZAM, 53, CHARIZARD, 0
...
AgathaData:
	db $FF, 55, HAUNTER, 56, CROBAT, 56, ANNIHILAPE, 58, ARBOK, 60, GENGAR, 0
...
MinaData:
	...
	db $FF, 58, MR_MIME, 58, BALUMBA, 59, PERITOP, 60, NINETALES, 61, WIGGLYTUFF, 0 ; Post-Game
