...
EvosMovesPointerTable:
	...
	dw SmujjEvosMoves
	dw BallerineEvosMoves
	dw ParasporEvosMoves
	dw PupperonEvosMoves
...
; Evolutions
	...
	db EVOLVE_ITEM, BLK_AUGURITE, 1, KLEAVOR
	db 0
; Learnset
	db 17, LEER
	db 20, FOCUS_ENERGY
