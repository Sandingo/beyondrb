...
CeladonMart4FClerkText:
	script_mart POKE_DOLL, FIRE_STONE, THUNDER_STONE, WATER_STONE, LEAF_STONE, SUN_STONE, ICE_STONE, DUSK_STONE

CeladonMart4FClerk2Text:
	script_mart METAL_COAT, KINGS_ROCK, DRAGON_SCALE, UP_GRADE, PROTECTOR, MAGMARIZER, ELECTIRIZER, OVAL_STONE, BLK_AUGURITE