...
CeladonMart2FClerk2Text:
	script_mart TM_DOUBLE_TEAM, TM_REFLECT, TM_LIGHT_SCREEN, TM_HEADBUTT, TM_HORN_DRILL, TM_MEGA_PUNCH, TM_MEGA_KICK, TM_TAKE_DOWN, TM_SUBMISSION

CeladonMart2FClerk3Text:
	script_mart TM_SWORDS_DANCE, TM_EXPLOSION, TM_BODY_SLAM, TM_EARTHQUAKE, TM_PSYCHIC_M, TM_FIRE_BLAST, TM_BLIZZARD, TM_THUNDER, TM_SOLARBEAM