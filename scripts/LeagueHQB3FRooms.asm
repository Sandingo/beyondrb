...
LeagueHQB3FRoomsTrainerHeader2:
	trainer EVENT_BEAT_LEAGUE_HQ_B3F_ROOMS_TRAINER_2, 1, LeagueHQB3FRoomsCoolTrainerFBattleText, LeagueHQB3FRoomsCoolTrainerFEndBattleText, LeagueHQB3FRoomsCoolTrainerFAfterBattleText
	db -1 ; end
