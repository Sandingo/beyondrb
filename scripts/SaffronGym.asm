...
SaffronGym_TextPointers:
	...
	dw_const SaffronGymReceivedTM46ShortText,     TEXT_SAFFRONGYM_RECIEVED_TM46_SHORT
...
SaffronGymSabrinaText.PreBattleRematch1Text
	text_far _SaffronGymRematchPreBattle1Text
	text_end

SaffronGymSabrinaText.PreBattleRematch2Text
	text_far _SaffronGymPreRematchBattle2Text
	text_end

SaffronGymSabrinaText.PreBattleRematchRefusedText
...
SaffronGymSabrinaText.SaffronGymRematchDefeatedText:
...
SaffronGymReceivedTM46ShortText:
	text_far _SaffronGymSabrinaReceivedTM46Text
	sound_get_item_1
	text_end