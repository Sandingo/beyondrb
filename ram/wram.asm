...
wEvoDataBuffer:: ds 5 * 8 + 1 ; Actual evolution size is stored in party_menu.asm
...
wMapSpriteExtraData:: ds 16 * 3 ; trainer class/item ID, trainer set ID
...
; trainer classes start at ID_OFFSET
