...
MapPalettesJumpTable:
	...
	db POWER_PLANT, PAL_PALLET
	db LORELEIS_ROOM, PAL_PALLET
	db BRUNOS_ROOM, PAL_CAVE
	db MT_SILVER_F1, PAL_GRAYMON
	db MT_SILVER_F2, PAL_GRAYMON
	db MT_SILVER_F3, PAL_GRAYMON
	db MT_SILVER_PEAK, PAL_SILVER_PEAK
	db MT_SILVER_EXTRA_ROOMS, PAL_GRAYMON
	db MT_SILVER_SUMMIT, PAL_SILVER_PEAK
	db -1
