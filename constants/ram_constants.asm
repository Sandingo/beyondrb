...
; wJumptableIndex
DEF JUMPTABLE_INDEX_MASK EQU %0111_1111
	const_def 7
	shift_const JUMPTABLE_EXIT

; wStatsMenuData
DEF STAT_SCREEN_PAGE_MASK EQU %0111_1111
DEF B_STAT_SCREEN_NO_SAVE_MENU_ITEM EQU 7
	DEF STAT_SCREEN_NO_SAVE_MENU_ITEM_MASK EQU 1 << B_STAT_SCREEN_NO_SAVE_MENU_ITEM
DEF STAT_SCREEN_FLAGS_MASK EQU STAT_SCREEN_NO_SAVE_MENU_ITEM_MASK