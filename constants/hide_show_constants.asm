...
; and are detected in wMissableObjectList)
	...
	const HS_VERMILION_OFFICER_JENNY
	const HS_VERMILION_MINA
	...
	const HS_ROUTE_24_CHARMANDER_GUY
	const HS_ROUTE_25_ITEM                 ; 26 X
	const HS_ROUTE_28_ITEM
	...
	const HS_VIRIDIAN_SCHOOL_KYLE
	const HS_VIRIDIAN_GYM_GIOVANNI         ; 32
	const HS_VIRIDIAN_GYM_KYLE
	const HS_VIRIDIAN_GYM_ITEM_1             ; 33 X
	const HS_VIRIDIAN_GYM_ITEM_2
	...
	const HS_GAME_CORNER_IMAKUNI
	const HS_WARDENS_HOUSE_ITEM            ; 47 X Unused
	const HS_POKEMON_MANSION_1F_ITEM_1     ; 48 X
	const HS_POKEMON_MANSION_1F_ITEM_2     ; 49 X
	const HS_INDIGO_LEAGUE_LOBBY_ABRA
...
;	const HS_VOLTORB_2                     ; 4E X - removed
	...
	const HS_MT_MOON_B1F_FOSSIL_1          
	const HS_MT_MOON_B1F_ITEM_1
	const HS_MT_MOON_B1F_ITEM_2
	const HS_MT_MOON_B1F_ITEM_3
	const HS_MT_MOON_B1F_ITEM_4
	...
	const HS_CERULEANTRADEHOUSE_MELANIE
	...
	const HS_ROCKET_HIDEOUT_B4F_ARCHER
...
;const HS_SILPH_CO_11F_OMEGADGE
	...
	const HS_POKEMON_MANSION_3F_ITEM_3
	...
	const HS_POKEMON_MANSION_B1F_ITEM_6
	...
	const HS_SAFARI_ZONE_NORTH_WORKER_1
	const HS_SAFARI_ZONE_NORTH_WORKER_2
	...
	const HS_SAFARI_ZONE_CENTER_ITEM_1       ; CD X
	const HS_SAFARI_ZONE_CENTER_ITEM_2
	...
	const HS_SEAFOAM_ISLANDS_B5F_ITEM_1
	const HS_SEAFOAM_ISLANDS_B5F_ITEM_2

DEF NUM_HS_OBJECTS EQU const_value

	const_def
	const HS_ROUTE_22_SILVERGUARD_1
	const HS_ROUTE_22_SILVERGUARD_2
	...
	const HS_MT_SILVER_F1_ITEM_1
	const HS_MT_SILVER_F1_ITEM_2
	const HS_MT_SILVER_F1_ITEM_3
	const HS_MT_SILVER_F1_ITEM_4
	const HS_MT_SILVER_F2_ITEM_1
	const HS_MT_SILVER_F2_ITEM_2
	const HS_MT_SILVER_F2_ITEM_3
	const HS_MT_SILVER_F2_ITEM_4
	const HS_MT_SILVER_F3_ITEM_1
	const HS_MT_SILVER_F3_ITEM_2
	const HS_MT_SILVER_F3_ITEM_3
	const HS_MT_SILVER_F3_ITEM_4
	const HS_MT_SILVER_EXTERIOR_ITEM_1
	const HS_MT_SILVER_EXTERIOR_ITEM_2
	const HS_MT_SILVER_PEAK_ITEM_1
	const HS_MT_SILVER_PEAK_ITEM_2
	const HS_MT_SILVER_EXTRAROOMS_ITEM_1
	const HS_MT_SILVER_EXTRAROOMS_ITEM_2
	const HS_MT_SILVER_SUMMIT_OAK
	const HS_LEAGUE_HQB_1F_ITEM_1
	const HS_LEAGUE_HQB_2F_ITEM_1
	const HS_LEAGUE_HQB_3F_ITEM_1
	const HS_LEAGUE_HQB_3F_ROOMS_ITEM_1
	const HS_LEAGUE_HQB_3F_ROOMS_ITEM_2
	const HS_LEAGUE_HQB_3F_ROOMS_ITEM_3
	const HS_LEAGUE_HQB_3F_ROOMS_ITEM_4
	const HS_LEAGUE_HQB_5F_ITEM_1
	const HS_LEAGUE_HQB_5F_ITEM_2
	const HS_LEAGUE_HQB_6F_ITEM_1
	const HS_LEAGUE_HQB_6F_ITEM_2
	const HS_LEAGUE_HQB_7F_ITEM_1
	const HS_LEAGUE_HQB_8F_ITEM_1
	const HS_LEAGUE_HQB_8F_ITEM_2
