...
; Pallet Town events
	...
	const EVENT_PRESSED_FOR_INFO_IN_STATUS_SCREEN
	const_skip 1
...
; League HQ Trainers - Custom
	const_next $920
	DEF LEAGUEHQTRAINERS_START EQU const_value
	const EVENT_AUTOWALKED_INTO_LEAGUEHQB1F_ROOM
	const EVENT_BEAT_LEAGUE_HQ_B1F_TRAINER_0
	const EVENT_BEAT_LEAGUE_HQ_B1F_TRAINER_1
	const_skip 6
	const EVENT_BEAT_LEAGUE_HQ_B3F_ROOMS_TRAINER_0
	const EVENT_BEAT_LEAGUE_HQ_B3F_ROOMS_TRAINER_1
	const EVENT_BEAT_LEAGUE_HQ_B3F_ROOMS_TRAINER_2
	const_skip 5
	const EVENT_BEAT_LEAGUE_HQ_B7F_TRAINER_0
	const_skip 7
	const EVENT_BEAT_LEAGUE_HQ_B8F_TRAINER_0
	const EVENT_BEAT_LEAGUE_HQ_B8F_TRAINER_1
	DEF LEAGUEHQTRAINERS_END EQU const_value - 1
...
; Custom Events
	...
	const EVENT_GET_REST_FIGHTING_DOJO_MONS
; Rematches
	...
	const EVENT_BEAT_KYLE_REMATCH
	const EVENT_BEAT_KOICHI_REMATCH
	const EVENT_MTMOONSQUARE_MOON_STONE
	const EVENT_MINA_BOTTLE_CAP_GIFT
