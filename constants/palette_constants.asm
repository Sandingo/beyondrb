...
; SuperPalettes indexes (see data/sgb/sgb_palettes.asm)
	...
	const PAL_SHINYGREENMON
	const PAL_SHINYREDMON
	const PAL_SHINYCYANMON
	const PAL_SHINYBROWNMON
	const PAL_SHINYYELLOWMON
	const PAL_SHINYBLUEMON
	const PAL_SHINYPURPLEMON
	const PAL_SHINYMEWMON
	const PAL_SHINYGRAYMON
	const PAL_SHINYPINKMON
	const PAL_SLOTS1    ; $1A
	const PAL_SLOTS2    ; $1B
	const PAL_SLOTS3    ; $1C
	const PAL_SLOTS4    ; $1D
